...
cap = cv2.VideoCapture('./songdoCCTV/mov/js/js3_1.mov')
...
with open('./colorROIsetting/songdoCCTV/js3_1.json') as json_file:
...
with open('./colorHistResult/newsongdoCCTV/js3_1_hist_out.json','w' ) as make_file:
